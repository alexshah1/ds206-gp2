MERGE {dst_db}.{dst_schema}.DimTerritories_SCD3 AS DST
USING 
(SELECT *
FROM {src_db}.{src_schema}.Territories) SRC
...
THEN 
    ...
    ,DST.TerritoryDescription_Prev1_ValidTo = (CASE WHEN DST.TerritoryDescription <> SRC.TerritoryDescription THEN GETDATE() ELSE DST.TerritoryDescription_Prev1_ValidTo END)
    ...
    ,DST.TerritoryDescription_Prev2_ValidTo = (CASE WHEN DST.TerritoryDescription <> SRC.TerritoryDescription THEN GETDATE() ELSE DST.TerritoryDescription_Prev2_ValidTo END),
    ...
    ,DST.RegionID_NK_FK_Prev1_ValidTo = (CASE WHEN DST.RegionID_NK_FK <> SRC.RegionID THEN GETDATE() ELSE DST.RegionID_NK_FK_Prev1_ValidTo END)
    ...
    ,DST.RegionID_NK_FK_Prev2_ValidTo = (CASE WHEN RegionID_NK_FK <> SRC.RegionID THEN GETDATE() ELSE DST.RegionID_NK_FK_Prev2_ValidTo END);